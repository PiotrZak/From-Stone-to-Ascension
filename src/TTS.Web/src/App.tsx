...
function AppLayout() {
  ...
  return (
    <div className={cn('min-h-screen text-foreground', isMatch ? 'match-app-bg' : 'home-app-bg')}>
      {!isMatch && (
      ...
      <main className={cn(isMatch ? 'mx-auto max-w-[1600px] px-3 py-4 sm:px-5' : 'mx-auto max-w-6xl px-4 py-6 sm:px-6')}>
        <Routes>
