...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground shadow-md shadow-primary/20 hover:brightness-110',
        ...
        secondary: 'border border-border bg-secondary text-secondary-foreground shadow-sm hover:brightness-110',
        ghost: 'border border-transparent hover:border-border hover:bg-secondary/60',
        link: 'text-primary underline-offset-4 hover:underline',
        critical: 'bg-[var(--secondary-container)] text-[var(--on-secondary-container)] shadow-md shadow-[var(--secondary-container)]/25 hover:brightness-110',
      },
      size: {
